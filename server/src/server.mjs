...
export function createApp(overrides={}) {
  ...
  const capabilityGaps=createCapabilityGapService({store,currentPlanningMode:()=>settingsConfig.claudeQuery.mode==="required"?"claude":null});
