...
export function resumeSourceOntology(sourceId:number,input:{taskId:string;answers?:import("./types").OntologyBuildAnswer[];approveChangeChecksum?:string}){return request<BackgroundTask>(`/sources/${sourceId}/ontology-build/resume`,{method:"POST",headers:writeHeaders,body:JSON.stringify(input)},20_000);}
