...
export type QueryRefusal = { refused:true; reason:string; failureClass?:string; sessionId?:string; missingTerm?:string; missingConfiguration?:string[]; attemptedSql?:string; planningMode?:"semantic"|"legacy"|"agent"; planningAttempts?:number; toolTrace?:QueryToolTrace[]; clarifications?:Array<{question:string;answer:string}> };
